...
const Login = () => {
  ...
  <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 place-items-center" onSubmit={handleSubmit}>
    ...
    <div className="mb-6">
      ...
      <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" type="text" name="password" value={thisUser.password} onChange={handleChange} placeholder="**************" />
    </div>
